...
class NotesTableViewController: UITableViewController, UISearchResultsUpdating {
    ...
    @IBAction func btnSortCategory(_ sender: UIBarButtonItem)
    {
    ...
    @IBAction func btnFolder(_ sender: UIBarButtonItem)
    {
        let alertBox = UIAlertController(title: "Do you want to put in Archieve folder", message: "Choose Criteria", preferredStyle: .alert)
        
        alertBox.addAction(UIAlertAction(title: "Archieve", style: .default, handler: { alert -> Void in
            self.tableView.reloadData()
        }))
        alertBox.addAction(UIAlertAction(title: "Cancel", style: .destructive, handler: nil))
        // 4. show the alertbox
    ...
    func getNotesByTitle() {
        ...
        do {
            ...
            print("Error while fetching tasks from database")
   ...
   override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    // Configure the cell...
        ...
        if tableView == resultsController.tableView {
            ...
            celll.backgroundColor = UIColor.red
  ...
  override func viewWillAppear(_ animated: Bool) {
       ...
       searchController.searchBar.autocapitalizationType = .none
        ...
        print("Welcome to the tasks controller")
        ...
        for note in self.notes {
            ...
            array.append("Title: \(note.title!) ; Description: \(String(describing: note.text!)) ; Days: \(note.days)")
        }
    ...
    @IBAction func unwindToTasksPage(_ unwindSegue: UIStoryboardSegue) {
